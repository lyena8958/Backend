	...
	<div class="sidebar-wrapper active">
		<div class="sidebar-header">
			<div class="d-flex justify-content-between">
				<div class="logo">
					<a href="main.jsp"><img src="assets/images/logo/YHS_LOGO1.png"
						alt="Logo" id="LOGO"></a>
				</div>
				<div class="toggler" id="menuClose">
					<a href="#" class="sidebar-hide d-xl-none d-block"><i
						class="bi bi-x bi-middle"></i></a>
				</div>
			</div>

			<p id="userHi">${userData.hmem}님,안녕하세요</p>
			<a href="logOutHRAdmin.do"><button id="basic"
					class="btn btn-outline-primary btn-lg btn-block">로그아웃</button></a> 
			<a href="myPage_HRAdmin.jsp"><button id="basic"
					class="btn btn-outline-primary btn-lg btn-block">마이페이지</button></a>
		</div>
		<div class="sidebar-menu">
			<ul class="menu">
				<li class="sidebar-title">Menu</li>
														
				<li class="sidebar-item active"><a href="main.jsp"
					class='sidebar-link'> <i class="bi bi-grid-fill"></i> <span>Data</span>
				</a></li>

				<li class="sidebar-item  has-sub ${type}"><a href="#"
					class='sidebar-link'> <i class="bi bi-stack"></i> <span>구성원</span>
				</a>
					<ul class="submenu ${type}">
						<li class="submenu-item "><a href="profile.jsp">*Profile</a>
						</li>
						<li class="submenu-item "><a href="insert_Mem.jsp">*채용발령</a>
						</li>
						<li class="submenu-item "><a href="select_Mem.jsp">*사원 조회</a>
						</li>
					</ul></li>

				<li class="sidebar-item  has-sub"><a href="#"
					class='sidebar-link'> <i class="bi bi-collection-fill"></i> <span>윤리 신고</span>
				</a>
					<ul class="submenu ">
						<li class="submenu-item "><a
							href="getListPost.do">조회</a></li>
...
<!-- 						<li class="submenu-item "><a
				...
				<li class="sidebar-item  has-sub"><a href="#"
					...
					<ul class="submenu ">
						...
						<li class="submenu-item "><a href="form-element-select.html">Select</a>
						</li>
				...
				<li class="sidebar-item  has-sub"><a href="#"
					...
					<ul class="submenu ">
						...
						<li class="submenu-item "><a href="form-editor-ckeditor.html">CKEditor</a>
						</li>
						<li class="submenu-item "><a
							href="form-editor-summernote.html">Summernote</a></li>
						<li class="submenu-item "><a href="form-editor-tinymce.html">TinyMCE</a>
						</li>
					</ul></li>
				...
				<li class="sidebar-item  has-sub"><a href="#"
					...
					<ul class="submenu ">
						...
						<li class="submenu-item "><a href="ui-widgets-todolist.html">To-do
								List</a></li>
					</ul></li>
				...
				<li class="sidebar-item  has-sub"><a href="#"
					...
					<ul class="submenu ">
						...
						<li class="submenu-item "><a href="ui-icons-fontawesome.html">Fontawesome</a>
						</li>
				...
				<li class="sidebar-item  has-sub"><a href="#"
					...
					<ul class="submenu ">
						...
						<li class="submenu-item "><a href="ui-chart-apexcharts.html">Apexcharts</a>
						</li>
					</ul></li>
				...
				<li class="sidebar-item  "><a href="application-checkout.html"
				...
				<li class="sidebar-item  has-sub"><a href="#"
					...
					<ul class="submenu ">
						...
						<li class="submenu-item "><a href="auth-forgot-password.html">Forgot
								Password</a></li>
					</ul></li>
				...
				<li class="sidebar-item  "><a
					href="https://github.com/zuramai/mazer#donate" class='sidebar-link'>
						<i class="bi bi-cash"></i> <span>Donate</span>
				</a></li>

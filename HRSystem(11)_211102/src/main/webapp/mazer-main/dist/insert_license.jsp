						...
						<div class="col-md-6 col-12">
							<div class="card">
								...
								<div class="card-content">
									<div class="card-body">
										<form class="form form-vertical" action="insertLicen.do"
											method="post">
											<div class="form-body">
												<div class="row">
													<div class="col-12">
														<div class="form-group has-icon-left">
															...
															<div class="position-relative">
																<input type="text" class="form-control"
																	placeholder="Email" id="email-id-icon" name="lmem" value="${param.lmem}" readonly>
													...
													<div class="form-group has-icon-left">
														...
														<div class="position-relative">
															<input type="date" class="form-control edit"
																placeholder="취득일자" id="email-id-icon" name="getDate" required>
															<div class="form-control-icon">
													...
													<div class="form-group has-icon-left">
														...
														<div class="position-relative">
															<input type="date" class="form-control edit"
																placeholder="만료일자" id="email-id-icon" name="expireDate" required>
															<div class="form-control-icon">
																<i class="fas fa-angle-double-right"></i>
															</div>
														</div>
													...
													<div class="form-group has-icon-left">
														...
														<div class="position-relative">
															<input type="text" class="form-control edit"
																placeholder="자격증 명" id="first-name-icon" name="lname" required>
															<div class="form-control-icon">
																<i class="fas fa-angle-double-right"></i>
															</div>
														</div>
												...
												<div class="col-12">
													...
													<div class="form-group has-icon-left">
														...
														<div class="position-relative">
															<input type="text" class="form-control edit"
																placeholder="등급" id="email-id-icon" name="grade" required>
															<div class="form-control-icon">
																<i class="fas fa-angle-double-right"></i>
															</div>
														</div>

        ...
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-md-8 col-lg-5 mb-6 text-center">
              <h5 class="text-danger">고객님!</h5>
              <h2>게시물 삭제가 완료되었습니다. :D</h2>
            </div>
            <div class="col-12">
              ...
              <div class="text-center">
                <a class="text-light" href="control.jsp?action=list"><button class="btn btn-primary px-5" type="submit"><i class="fas fa-phone-alt me-2"></i>처음으로 이동하기</button></a>
              </div>
            </div>
          </div>
        </div>

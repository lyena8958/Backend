    ...
    <main class="main" id="loginTop">
      <section class="py-xxl-10 pb-0" id="home">
        <div class="bg-holder bg-size" style="background-image:url(assets/img/gallery/hero-header-bg.png);background-position:top center;background-size:cover;">
              ...
              <form class="row" name="form1" method="post" action="loginCheck.jsp">
                <div class="mb-3">
                  <label class="form-label visually-hidden" for="inputName">ID</label>
                  <input class="form-control form-quriar-control" id="inputName" type="text" name="userID" placeholder="아이디를 입력하세요." required minlength="5" maxlength="10"/>
                </div>
                 <div class="mb-3">
                  <label class="form-label visually-hidden" for="inputName">PW</label>
                  <input class="form-control form-quriar-control" id="inputPW" type="text" name="userPW" placeholder="비밀번호를 입력하세요." required minlength="5" maxlength="10"/>
                </div>
                <div class="mb-3">
                  <label class="form-label visually-hidden" for="inputName">고객선택</label>
                  <span class="memberSelect"><input type="radio" name="mod" value="소비자"/>소비자</span>

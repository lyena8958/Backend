...
public class OrderMemberDAO {
	...
	String sql_SELECT_USER = "SELECT * FROM ORDERMEMBER WHERE USERID=?";
	...
	String sql_INSERT = "INSERT INTO ORDERMEMBER (ONUM, USERNAME, USERID, USERPW) VALUES ((SELECT NVL(MAX(ONUM), 0)+1 FROM ORDERMEMBER), ?, ?, ?)";

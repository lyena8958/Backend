...
<jsp:useBean id="userReviews" class="java.util.ArrayList" scope="request"/>
<!DOCTYPE html>
...
%>
           ...
           <h5 class="my-4">저장된 게시물이 존재하지 않습니다.</h5>
         </div>
<%
	}
            ...
            <div class="col-md-4 pt-4 px-md-2 px-lg-3">
              <div class="card h-100 px-lg-5 card-span">
                <div class="card-body d-flex flex-column justify-content-around">
                  <div class="text-center pt-5">
                    <a href=""><h5 class="my-4"><%=vo.getTitle() %></h5></a>
                  </div>
                  ...
                  <div class="text-center my-5">
                    <div class="d-grid">
                      <a href="control.jsp?action=editreview&rnum=<%= vo.getRnum() %>"><button class="btn btn-danger hover-top btn-glow border-0" type="submit">Learn more</button></a>
                    </div>
                  </div>
                </div>
              </div>

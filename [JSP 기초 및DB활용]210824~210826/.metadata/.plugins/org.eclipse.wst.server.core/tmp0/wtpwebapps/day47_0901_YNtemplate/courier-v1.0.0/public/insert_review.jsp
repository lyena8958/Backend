              ...
              <div class="card h-100 px-lg-5 card-span">
                <div class="card-body d-flex flex-column justify-content-around">
                  <div class="text-center pt-5">
                    <input type="text" maxlength="30" name="title" placeholder="제목">
                  </div>
                  <div class="text-center pt-5">
                    <input type="text" maxlength="10" name="writer" placeholder="이름">
                  </div>
                  <div class="text-center pt-5">
                    <input type="text" maxlength="30" name="content" placeholder="세부내용">
                  </div>
                  ...
                  <!-- <input type="text" maxlength="30" name="content" value="세부내용"> -->
